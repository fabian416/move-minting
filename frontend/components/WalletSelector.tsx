...
export function WalletSelector() {
  ...
  if (connected && account?.address) {
    ...
    const label = account.ansName ?? (addr ? truncateAddress(addr) : "Unknown");
...
function ConnectWalletDialog({ close }: ConnectWalletDialogProps) {
  ...
  return (
    // aria-describedby evita el warning de Radix cuando no hay Description
    <DialogContent className="max-h-screen overflow-auto" aria-describedby={undefined}>
      <AboutAptosConnect renderEducationScreen={renderEducationScreen}>
        {/* AptosConnect no soporta uploads, sólo mostrar en la página pública de mint */}
        {isPublicMintPage ? (
          <>
